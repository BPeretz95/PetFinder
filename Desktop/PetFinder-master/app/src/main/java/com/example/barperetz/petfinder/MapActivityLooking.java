...
public class MapActivityLooking extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_maps_looking);
        ...
        MapActivityLooking.this.setTitle("Map");
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            case R.id.action_report_lost:
                Intent intent = new Intent(MapActivityLooking.this, LostPetReport.class);
                startActivity(intent);
                return true;

            case R.id.action_shelters:
                Intent intent2 = new Intent(MapActivityLooking.this, ShelterSearch.class);
