...
public class FoundPetReport extends AppCompatActivity {
     ...
     */
    private FoundPetReport.AddressResultReceiver mResultReceiver;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mLocationAddressTextView = (TextView) findViewById(R.id.locationView);
        mFetchAddressButton = (Button) findViewById(R.id.buttonLocation);
    ...
    public void fetchAddressButtonHandler(View view) {
        buttonLocation = mFetchAddressButton;
        ...
        if (shouldProvideRationale) {
            ...
            showSnackbar(R.string.permission_rationale, android.R.string.ok,
                    new View.OnClickListener() {
                        ...
                        public void onClick(View view) {
                            // Request permission
                            ActivityCompat.requestPermissions(FoundPetReport.this,
